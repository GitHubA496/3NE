...
Files: wizard-transformed.glb [3.56MB] > E:\JS\Nextjs-Creative-Portfolio-Starter-Code-Files\public\models\wizard-transformed-transformed.glb [3.55MB] (0%)
*/
"use client"
...
export default function Wizard(props) {
  ...
  useFrame((state,delta,xrFrame) => (modelRef.current.position.y = -1.8 + (Math.sin(state.clock.elapsedTime) * 0.2)))
